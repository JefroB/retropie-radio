#!/bin/sh
function appendags {
	echo -e "\x1B[35m Checking for ags emulator. \x1B[0m"
	...
	then 
		...
		wait
    		echo -e "\x1B[30m Appending emulators.cfg file. Please choose new emulator option next time you run this emulator. \x1B[0m"
...
function appendamiga {
	echo -e "\x1B[34m Checking for amiga emulator. \x1B[0m"
...
function appendamstrad {
	echo -e "\x1B[31m Checking for amstradcpc emulator. \x1B[0m"
...
function appendatari2600 {
	echo -e "\x1B[36m Checking for atari2600 emulator. \x1B[0m"
...
function appendatari5200 {
	echo -e "\x1B[36m Checking for atari5200 emulator. \x1B[0m"
...
function appendatari7800 {
	echo -e "\x1B[32m Checking for atari7800 emulator. \x1B[0m"
...
function appendatari800 {
	echo -e "\x1B[35m Checking for atari800 emulator. \x1B[0m"
...
function appendatarilynx {
	echo -e "\x1B[34m Checking for atarilynx emulator. \x1B[0m"
...
function appendatarist {
	echo -e "\x1B[31m Checking for atarist emulator. \x1B[0m"
...
function appendc128 {
	echo -e "\x1B[33m Checking for c128 emulator. \x1B[0m"
...
function appendc64 {
	echo -e "\x1B[36m Checking for c64 emulator. \x1B[0m"
...
function appendcavestory {
	echo -e "\x1B[36m Checking for cavestory emulator. \x1B[0m"
...
function appendcoco {
	echo -e "\x1B[32m Checking for coco emulator. \x1B[0m"
...
function appendcoleco {
	echo -e "\x1B[35m Checking for coleco emulator. \x1B[0m"
...
function appenddescent1 {
	echo -e "\x1B[34m Checking for descent1 emulator. \x1B[0m"
...
function appenddescent2 {
	echo -e "\x1B[31m Checking for descent2 emulator. \x1B[0m"
...
function appenddragon32 {
	echo -e "\x1B[33m Checking for dragon32 emulator. \x1B[0m"
...
function appenddragon64 {
	echo -e "\x1B[36m Checking for dragon64 emulator. \x1B[0m"
...
function appenddreamcast {
	echo -e "\x1B[36m Checking for dreamcast emulator. \x1B[0m"
...
function appendduke3d {
	echo -e "\x1B[32m Checking for duke3d emulator. \x1B[0m"
...
function appendfba {
	echo -e "\x1B[35m Checking for fba emulator. \x1B[0m"
...
function appendfds {
	echo -e "\x1B[34m Checking for fds emulator. \x1B[0m"
...
function appendgameandwatch {
	echo -e "\x1B[31m Checking for gameandwatch emulator. \x1B[0m"
...
function appendgb {
	echo -e "\x1B[33m Checking for gb emulator. \x1B[0m"
...
function appendgba {
	echo -e "\x1B[36m Checking for gba emulator. \x1B[0m"
...
function appendgbc {
	echo -e "\x1B[36m Checking for gbc emulator. \x1B[0m"
...
function appendintellivision {
	echo -e "\x1B[32m Checking for intellivision emulator. \x1B[0m"
...
function appendkodi {
	echo -e "\x1B[35m Checking for kodi. \x1B[0m"
	...
	then 
		...
		wait
    		echo -e "\x1B[30m Appending emulators.cfg file. Please choose new emulator option next time you run kodi. \x1B[0m"
...
function appendmame-advmame {
	echo -e "\x1B[31m Checking for mame-advmame emulator. \x1B[0m"
...
function appendmame-libretro {
	echo -e "\x1B[33m Checking for mame-libretro emulator. \x1B[0m"
...
function appendmame-mame4all {
	echo -e "\x1B[36m Checking for mame-mame4all emulator. \x1B[0m"
...
function appendmastersystem {
	echo -e "\x1B[36m Checking for mastersystem Checking for emulator. \x1B[0m"
...
function appendmegadrive {
	echo -e "\x1B[32m Checking for megadrive emulator. \x1B[0m"
...
function appendminecraft {
	echo -e "\x1B[34m Checking for minecraft emulator. \x1B[0m"
...
function appendmsx {
	echo -e "\x1B[34m Checking for msx emulator. \x1B[0m"
...
function appendn64 {
	echo -e "\x1B[31m Checking for n64 emulator. \x1B[0m"
...
function appendnes {
	echo -e "\x1B[33m Checking for nes emulator. \x1B[0m"
...
function appendngp {
	echo -e "\x1B[36m Checking for ngp emulator. \x1B[0m"
...
function appendopentdd {
	echo -e "\x1B[36m Checking for opentdd emulator. \x1B[0m"
...
function appendpc {
	echo -e "\x1B[32m Checking for pc emulator. \x1B[0m"
...
function appendpcengine {
	echo -e "\x1B[35m Checking for pcengine emulator. \x1B[0m"
...
function appendpet {
	echo -e "\x1B[34m Checking for pet emulator. \x1B[0m"
...
function appendpsp {
	echo -e "\x1B[34m Checking for psp emulator. \x1B[0m"
...
function appendpsx {
	echo -e "\x1B[34m Checking for psx emulator. \x1B[0m"
...
function appendquake {
	echo -e "\x1B[31m Checking for quake emulator. \x1B[0m"
...
function appendquake3 {
	echo -e "\x1B[31m Checking for quake 3 emulator. \x1B[0m"
...
function appendscummvm {
	echo -e "\x1B[31m Checking for scummvm emulator. \x1B[0m"
...
function appendsega32x {
	echo -e "\x1B[31m Checking for sega32x emulator. \x1B[0m"
...
function appendsegacd {
	echo -e "\x1B[31m Checking for segacd emulator. \x1B[0m"
...
function appendsg-1000 {
	echo -e "\x1B[31m Checking for sg-1000 emulator. \x1B[0m"
...
function appendsnes {
	echo -e "\x1B[33m Checking for snes emulator. \x1B[0m"
...
function appendvectrex {
	echo -e "\x1B[36m Checking for vectrex emulator. \x1B[0m"
...
function appendvic20 {
	echo -e "\x1B[36m Checking for vic20 Checking for emulator. \x1B[0m"
...
function appendvideopac {
	echo -e "\x1B[32m Checking for videopac emulator. \x1B[0m"
...
function appendvirtualboy {
	echo -e "\x1B[35m Checking for virtualboy emulator. \x1B[0m"
...
function appendwonderswan {
	echo -e "\x1B[34m Checking for wonderswan emulator. \x1B[0m"
...
function appendzxspectrum {
	echo -e "\x1B[31m Checking for zxspectrum emulator. \x1B[0m"
