...
function getmusicdirectory {
	...
	then 
    		...
    		#
    		# CREATE INTERFACE TO ASK USER FOR MUSIC DIRECTORY
    		#
    		MUSICDIR="$USERDEFINEDMUSICDIR"
...
function createsymlink {
	echo -e "\x1B[31m Creating symlink to music folder... \x1B[0m"
